...
def addDataCLOptions(parser, ref=False, mc=False, ipol=False, scan=False):
    ...
    # TODO: Migrate to a single name: I prefer just "--weights"
    g.add_option("--weights", "--obsfile",
                 metavar = "WEIGHTS",
                 dest = "OBSERVABLEFILE",
...
def addRunCombsCLOptions(parser):
    ...
    # TODO: Migrate to a single name: I prefer just "--runs", cf. "--weights"
    parser.add_option("-R",  "--runs", "--runsfile", "--runcombs",
                      dest="RUNSFILE",
                      default=None,
