...
class InterpolationSet(dict):
    ...
    * :meth:`mkFromPickle`
    ...
    def mkFromBinDists(cls, bindists, runskey, ipolmethod, center=None):
        ...
        ipolmethod : class
            The interpolation method that is used given as a class. The
            class must have a :meth:`mkFromBinDist` method.
        ...
        for bd in bindists:
            ipols[bd.binid] = ipolmethod.mkFromBinDist(bd, center)
    ...
    def addBinDistribution(self, bd):
        self[bd.binid] = self.ipolmethod.mkFromBinDist(bd)
