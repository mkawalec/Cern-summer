...
Rivet package::
    ...
    compare-histos -R histos-0.aida:"Professor prediction" -o plots
...
Or use the :program:`rivet-mkhtml` script from Rivet.
...
You can of course also use :program:`prof-I` for that. E.g. within :program:`prof-I` hit
