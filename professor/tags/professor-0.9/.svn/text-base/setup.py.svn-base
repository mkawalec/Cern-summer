...
try:
    ...
    try:
        ...
        print "PyMinuit is not installable with setuptools at the moment!"
        print "** Please install pyminuit or pyminuit2 BY HAND **"
        print
        print "See the homepage for information:"
        print "    http://code.google.com/p/pyminuit/"
        print "and"
        print "    http://projects.hepforge.org/professor/trac/wiki/PyMinuit"
        print
        print "** Please install pyminuit or pyminuit2 BY HAND **"
        sys.exit(1)
